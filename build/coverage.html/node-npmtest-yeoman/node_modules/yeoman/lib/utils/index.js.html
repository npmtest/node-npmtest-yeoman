...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-yeoman/node_modules/yeoman/lib/utils/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-yeoman/node_modules/yeoman/lib/utils/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-yeoman/node_modules/yeoman/lib/utils/</a> &#187; index.js</div>
</div>
<div class="body">
  ...
  [
    ...
    return (
      ...
      descriptor[ api.replace(/\W/g, '') ] = {
        get: <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >return require(api); </span>}
      },
...
utils.extend = <span class="fstat-no" title="function not covered" >function extend(o) {</span>
<span class="cstat-no" title="statement not covered" >  Object.keys(utils).forEach(<span class="fstat-no" title="function not covered" >function(prop) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        return utils[prop];</span>
      }
    });
  });
...
//
utils.join = <span class="fstat-no" title="function not covered" >function join() {</span>
<span class="cstat-no" title="statement not covered" >  var args = Array.prototype.slice.call(arguments);</span>
<span class="cstat-no" title="statement not covered" >  return path.join.apply(path, args).replace(/\\/g, '/');</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
